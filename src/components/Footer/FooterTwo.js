                        ...
                        <div className="footer-top-cta wow animate__fadeInUp" data-wow-duration="0.6s">
                            <div className="row">
                                <div className="col-lg-7">
                                    <h4>{ctaSubtitle ? ctaSubtitle : 'Free Online recipient'}</h4>
                                    <h3>{ctaTitle ? ctaTitle : 'Ready to dive in? Start your free recipient today.'}</h3>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-lg-3 md-mb-30">
                                <div className="footer-widget footer-widget-1">
                                    ...
                                    <h5 className="footer-subtitle">There are recipient and event custom <br/>
                                    post types so you can easily create and<br/> manage recipient, events.</h5>
                                    <ul className="footer-address">
                                        ...
                                        <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><a href=""> inspirecoach@gmail.com </a></li>
                                    </ul>                               
                                </div>
                            </div>
                            <div className="col-lg-3 md-mb-30">
                                <div className="footer-widget footer-widget-2">
                                    ...
                                    <div className="footer-menu">
                                        <ul>
                                            ...
                                            {/* <li><Link to="/recipient">recipients</Link></li>
