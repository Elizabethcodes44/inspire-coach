...
const Header = (props) => {
	const { topbarEnable, menuCategoryEnable, headerClass, parentMenu, headerNormalLogo, headerStickyLogo,  defaultTheme, onThemeChange  } = props;
										...
										<div className="logo">
											{
												...
												<Link to="/" className="logo-text">
													<img src={headerStickyLogo ? headerStickyLogo : stickyLogo} alt="" width="100px" />
												</Link> :
												<Link to="/" className="logo-text">
													<img src={headerNormalLogo ? headerNormalLogo : normalLogo} alt="" width="100px" />
												</Link>
											}
										</div>
										<Switch
